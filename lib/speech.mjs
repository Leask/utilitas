...
import {
    call, countKeys, ignoreErrFunc, inBrowser, need, throwError
} from './utilitas.mjs';
...
const [
    BUFFER, STREAM, FILE, clients, suffix, SPEAKER, cleanup, ,
    GPT_4O_MIMI_TTS, GPT_4O_TRANSCRIBE, OPENAI_TTS_MAX_LENGTH,
    WHISPER_DEFAULT_MODEL, errorMessage,
] = [
        'BUFFER', 'STREAM', 'FILE', {}, 'ogg', 'SPEAKER', true,
