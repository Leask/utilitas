...
let provider, pool, actExecute, bracket, actDuplicate, sqlShowTable,
    defaultPlaceholder, sqlShowIndex, fieldCountResult, sqlDescTable;
...
const desc = async (table, options) => {
    assertTable(table);
    const [resp, result] = [await query(sqlDescTable, [table]), {}];
