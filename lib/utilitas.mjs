...
const renderCode = (code, options) => {
    let i = 0;
    const arrCode = ensureString(code, options).split('\n');
    const bits = String(arrCode.length).length;
    return arrCode.map(x => `${String(++i).padStart(bits, '0')}|${x}`).join('\n');
};
