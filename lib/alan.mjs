...
import {
    ensureString, ignoreErrFunc, log as _log, need, parseJson,
...
const MODELS = {
    ...
    [GEMINI_15_FLASH_VERTEX]: {
        ...
        requestLimitsRPD: 10000,
        requestLimitsRPM: 360,
        tokenLimitsTPM: 10 * 1000000,
        trainingData: 'April 9, 2024',
        vision: true,
        supportedMimeTypes: [
