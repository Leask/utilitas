...
const [
    ...
    TOOLS, TEXT, OK, FUNC, GPT_5, GPT_5_MINI, GEMMA_3_27B, ANTHROPIC, v8k, ais,
    ...
    OPENROUTER, AUTO,
        ...
        x => x.replace(/[\.\s]*$/, ''), 'google/gemini-2.5-flash-image',
        'image', 'Jina', 'jina-deepsearch-v1', 'google/gemini-2.5-pro',
