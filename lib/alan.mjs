...
const [
    OPENAI, GOOGLE, OLLAMA, NOVA, MD_CODE, CLOUD_OPUS_46, AUDIO, WAV,
    OPENAI_VOICE, GPT_REASONING_EFFORT, THINK, THINK_STR, THINK_END, TOOLS_STR,
    TOOLS_END, TOOLS, TEXT, OK, FUNC, GPT_54, GPT_IMAGE_15, GEMMA_4_31B,
    ...
    PROCESSING, CURSOR, LN1, LN2, TOP, DEEP_RESEARCH_PRO, MD_CODE_ESCAPED,
    VERTEX, LYRIA_002,
] = [
        'OpenAI', 'Google', 'Ollama', 'nova', '```', 'claude-opus-4.6', 'audio',
        'wav', 'OPENAI_VOICE', 'medium', 'think', '<think>', '</think>',
        '<tools>', '</tools>', 'tools', 'text', 'OK', 'function', 'gpt-5.4',
        'gpt-image-1.5', 'gemma4:31b', 'Anthropic', [], 30, { log: true },
        'Alan', 'user', { role: 'system' }, { role: 'assistant' },
        'json_object', 'Prompt is required.',
        ...
        'deep-research-pro-preview-12-2025', '\`\`\`', 'Vertex', 'lyria-002',
    ];
