...
const [
    ...
    DEFAULT_GPT_TRAINING_MODEL,
        ...
        GPT_4, GEMINI_PRO_VISION, GEMINI_PRO, TEXT_EMBEDDING_ADA_002,
        EMBEDDING_001, EMBEDDING_GECKO_ML001, GPT_35_TURBO,
    ];
...
const createGptFineTuningJob = async (training_file, options) => {
    ...
    return await client.fineTuning.jobs.create({
        training_file, model: options?.model || GPT_35_TURBO_1106,
    })
};
