...
const [
    ...
    GEMINI_25_FLASH, NOVA, DEEPSEEK_R1, MD_CODE, TEXT_EMBEDDING_3_SMALL,
    ...
    GEMINI_20_FLASH, IMAGE, JINA, JINA_DEEPSEARCH, JINA_CLIP, VERTEX,
    GEMINI_25_PRO, SILICONFLOW, SF_DEEPSEEK_V3,
] = [
        'OpenAI', 'Gemini', 'OPENAI_TRAINING', 'Ollama', 'gpt-4o', 'o1',
        'o3-mini', 'gemini-2.5-flash-preview-04-17', 'nova', 'deepseek-r1',
...
const buildPrompts = async (model, input, options = {}) => {
    ...
    switch (options.flavor) {
        ...
        case GEMINI:
            const _role = {
                role: [GEMINI_20_FLASH, GEMMA_3_27B].includes(options.model)
                    ? user : system
            };
    ...
    if ([OPENAI].includes(options.flavor)
        || [GEMINI_20_FLASH, GEMMA_3_27B].includes(options.model)) {
        systemPrompt = null;
    }
