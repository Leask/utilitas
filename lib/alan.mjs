...
const [
    GPT_35_TURBO, GPT_4O, GEMINI_PRO, GEMINI_PRO_15, EMBEDDING_001,
    EMBEDDING_GECKO_001, EMBEDDING_GECKO_002, EMBEDDING_GECKO_ML001, MISTRAL,
    TEXT_EMBEDDING_3_SMALL, TEXT_EMBEDDING_3_LARGE,
] = [
        'gpt-3.5-turbo', 'gpt-4o', 'gemini-pro', 'gemini-1.5-pro-preview-0409',
        'embedding-001', 'textembedding-gecko@001', 'textembedding-gecko@002',
...
const DEFAULT_MODELS = {
    ...
    [OPENAI_TRAINING]: GPT_35_TURBO,
    [VERTEX_EMEDDING]: EMBEDDING_GECKO_ML001,
    [VERTEX]: GEMINI_PRO_15,
};
