...
const [
    ...
    GEMINI_25_PRO_TTS, wav, PNG_EXT, GPT_4O_MIMI_TTS, GPT_4O_TRANSCRIBE,
    INVALID_AUDIO, OGG_EXT, ELLIPSIS, TOP_LIMIT, ATTACHMENT, PROCESSING, CURSOR,
    LN1, LN2, TOP, DEEP_RESEARCH_MAX, MD_CODE_ESCAPED, VERTEX, LYRIA_002,
] = [
        ...
        'Error generating content.', 'gemini-2.5-pro-preview-tts', 'wav', 'png',
