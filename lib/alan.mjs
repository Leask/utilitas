...
const _NEED = ['@google/generative-ai', 'js-tiktoken', 'ollama', 'OpenAI'];

const [
    GPT_4O_MINI, GPT_4O, GPT_O1, GPT_O1_MINI, GEMINI_20_FLASH, EMBEDDING_001,
    MISTRAL, TEXT_EMBEDDING_3_SMALL, TEXT_EMBEDDING_3_LARGE,
] = [
        'gpt-4o-mini', 'gpt-4o', 'o1-preview', 'o1-mini',
        'gemini-2.0-flash-exp', 'embedding-001', 'mistral',
...
const [
    ...
    OPENAI_TRAINING, OLLAMA,
        ...
        'GEMINI_EMEDDING', 'OPENAI_TRAINING', 'OLLAMA',
    ];
...
const [getOpenAIClient, getGeminiClient, getOllamaClient]
    = [OPENAI, GEMINI, OLLAMA].map(
    ...
    for (const i in options.engines) {
        ...
        switch (key) {
            case ASSISTANT:
                ...
                break;
            case CHATGPT: case GEMINI: case OLLAMA:
