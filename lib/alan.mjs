...
const [
    ...
    TOOLS_END, TOOLS, TEXT, OK, FUNC, GPT_55, GPT_IMAGE_15, GEMMA_4_31B,
    ...
    GEMINI_25_PRO_TTS, wav, PNG_EXT, GPT_AUDIO, ELLIPSIS, TOP_LIMIT, ATTACHMENT,
...
const initChat = async (options = {}) => {
    ...
    for (const ai of ais.filter(x => ![
        IMAGEN_4_UPSCALE, VEO_31, LYRIA_002,
