...
const [
    ...
    GEMINI_31_PRO, GEMINI_30_FLASH, IMAGEN_4_ULTRA, VEO_31, IMAGEN_4_UPSCALE,
    ...
    DEEP_RESEARCH_PRO, MD_CODE_ESCAPED,
] = [
...
// for (const n of [GPT_52, GPT_52_CODEX, GEMINI_31_PRO, GEMINI_30_FLASH]) {
