...
const [GPT4, GPT4_1106, GEMINI_PRO, GEMINI_PRO_VISION, EMBEDDING_ADA] = [
    'gpt-4', 'gpt-4-1106-preview', 'gemini-pro', 'gemini-pro-vision',
    'text-embedding-ada-002',
];

const [
    openaiDefaultModel, vertexDefaultModel, geminiDefaultModel, embeddingModel
] = [GPT4, GEMINI_PRO_VISION, GEMINI_PRO, EMBEDDING_ADA];
...
const createOpenAIEmbedding = async (input, options) => {
    ...
    // Adding support for Google Vertex AI Embedding API:
