...
const [
    GPT_35_TURBO, GPT_4, GPT_4_VISION, GEMINI_PRO, GEMINI_PRO_15,
    ...
    TEXT_EMBEDDING_3_LARGE, GPT_4_TURBO
        ...
        'gpt-3.5-turbo', 'gpt-4', 'gpt-4-vision-preview', 'gemini-pro',
        'gemini-1.5-pro-preview-0409', 'embedding-001', 'textembedding-gecko@001',
