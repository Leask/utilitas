...
const [
    ...
    CLAUDE_35_HAIKU, AUDIO, WAV, CHATGPT_MINI, ATTACHMENTS,
] = [
...
const talk = async (input, options) => {
    ...
    const audioMode = !!(options?.attachments || []).find(
        x => _MODEL.supportedAudioTypes || [].includes(x.mime_type)
    ) || undefined;
