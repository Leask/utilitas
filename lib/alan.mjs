...
const [
    ...
    GEMINI_30_FLASH, IMAGEN_4_ULTRA, VEO_31, IMAGEN_4_UPSCALE, ERROR_GENERATING,
        ...
        if (M.name === IMAGEN_4_UPSCALE) {
            ...
            resp = await client.models.generateImages({
                model: M.name, prompt, config: mergeAtoB(options?.config, {
                    ...
                    aspectRatio: '16:9', personGeneration: 'allow_all',
                }),
            });
        }
...
const initChat = async (options = {}) => {
    ...
    for (const ai of ais.filter(x => ![
        IMAGEN_4_ULTRA, IMAGEN_4_UPSCALE, VEO_31, GPT_4O_TRANSCRIBE, LYRIA_002,
