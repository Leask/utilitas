...
const [
    ...
    NOVA, EMBEDDING_001, MISTRAL, TEXT_EMBEDDING_3_SMALL,
    TEXT_EMBEDDING_3_LARGE, CLAUDE_35_SONNET, CLAUDE_35_HAIKU, AUDIO, WAV,
        ...
        'o1-preview', 'o1-mini', 'gemini-2.0-flash-exp', 'nova',
...
const packResp = async (resp, options) => {
    let { text: txt, audio } = String.isString(resp) ? { txt: resp } : resp;
...
const packGptResp = async (resp, options) => {
    ...
    return await packResp({ text, audio }, options);
};
