...
import { ensureArray, importModule, log as _log, throwError } from './utilitas.mjs';
...
const ping = async (host, options = { timeout: 3, min_reply: 3 }) => {
    ...
    return await (await importModule('ping')).default.promise.probe(host, options);
};
