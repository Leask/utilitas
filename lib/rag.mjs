...
const buildOpenAIClientOptions = (options = {}, baseURL) => {
    const clientOptions = { ...options, baseURL };
    for (const key of [
        'provider', 'model', 'modelConfig', 'source', 'debug',
...
const initEmbedding = async (options = {}) => {
    ...
    embeddingClients[provider] = {
        client: new OpenAI(buildOpenAIClientOptions(options, baseURL)),
